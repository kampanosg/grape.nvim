...
----------------------------------
Group.new('Boolean', c.bg, c.const, no)
Group.new('Character', c.bg, c.const, no)
Group.new('Comment', c.bg, c.comment, i)
Group.new('Conditional', c.bg, c.keyword, no)
Group.new('Constant', c.bg, c.const, no)
Group.new('Todo', c.bg, c.bg, no)
Group.new('Define', c.bg, c.keyword, no)
Group.new('DiffAdd', c.diffadd, c.diffadd, no)
...
Group.new('ErrorMsg', c.bg, c.warning, b)
Group.new('WarningMsg', c.fg, c.warning2, no)
Group.new('Float', c.bg, c.const, no)
Group.new('Function', c.bg, c.func, no)
Group.new('Identifier', c.bg, c.type, i)
Group.new('Keyword', c.bg, c.keyword, b)
Group.new('Label', c.bg, c.var, no)
Group.new('NonText', c.bg4, c.bg2)
Group.new('Number', c.bg, c.const, no)
Group.new('Operator', c.bg, c.keyword, no)
Group.new('PreProc', c.bg, c.keyword, no)
Group.new('Special', c.bg, c.fg, no)
Group.new('SpecialKey', c.bg2, c.fg2, no)
Group.new('Statement', c.bg, c.keyword, no)
Group.new('StorageClass', c.bg, c.type, i)
Group.new('String', c.str, c.bg, no)
Group.new('Tag', c.bg, c.keyword, no)
Group.new('Title', c.bg, c.fg, b)
Group.new('Todo', c.fg2, c.bg, b)
Group.new('Type', c.type, c.bg, no)
