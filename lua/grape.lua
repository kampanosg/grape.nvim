...
----------------------------------
Group.new('Boolean', c.const, c.bg, no)
Group.new('Character', c.const, c.bg, no)
Group.new('Comment', c.bg, c.comment, i)
Group.new('Conditional', c.keyword, c.bg, no)
Group.new('Constant', c.const, c.bg, no)
Group.new('Todo', c.bg, c.bg, no)
Group.new('Define', c.keyword, c.bg, no)
...
Group.new('Float', c.const, c.bg, no)
Group.new('Function', c.func, c.bg, no)
Group.new('Identifier', c.type, c.bg, i)
Group.new('Keyword', c.keyword, c.bg, b)
Group.new('Label', c.var, c.bg, no)
Group.new('NonText', c.bg4, c.bg2)
Group.new('Number', c.const, c.bg, no)
Group.new('Operator', c.keyword, c.bg, no)
Group.new('PreProc', c.keyword, c.bg, no)
Group.new('Special', c.fg, c.bg, no)
Group.new('SpecialKey', c.fg2, c.bg2, no)
Group.new('Statement', c.keyword, c.bg, no)
Group.new('StorageClass', c.type, c.bg, i)
Group.new('String', c.str, c.bg, no)
Group.new('Tag', c.keyword, c.bg, no)
Group.new('Title', c.fg, c.bg, b)
